...
export function AnalysisExports() {
  ...
  const downloadCsv = () => {
    ...
    link.href = url;
    link.download = `garuda-lens-${manifest.analysis_id}.csv`;
    link.click();
